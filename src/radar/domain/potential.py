...
_EARLY_STAGE_TERMS = {
    "pilot", "prototype", "beta", "sandbox", "trial", "experiment",
    "research preview", "proof of concept", "poc", "tests", "testing",
    "試點", "原型", "測試", "實驗", "沙盒", "概念驗證",
}
_APPLICATION_TERMS = {
...
_COMBINATION_TERMS = {
    ...
    "integrated with", "x ai", "ai x", "新組合", "跨領域", "結合", "融合",
}
_TREND_TERMS = {
    "adoption", "rollout", "expansion", "scaling", "diffusion",
    "growing demand", "new region", "procurement",
    "採用", "擴張", "擴散", "規模化", "新市場", "採購",
}
_POTENTIAL_DELTA_TYPES = {
    "new_source_confirmation", "new_entity", "launch_or_release",
    "pilot_to_production", "new_region", "adoption_expansion",
    "funding_change", "hiring_change", "supply_chain_change", "trend_evidence_only",
}
...
def assess_event(event: Event) -> PotentialAssessment:
    ...
    if candidate_type is None or score < 30:
...
def next_check_at(event: Event) -> str:
