...
This skill exists because generic web search often misses Instagram, X, Facebook, Threads, YouTube, TikTok, LINE OA, Newsletter, Website / Linktree, and other channel-native content.

## Baseline required channels

The baseline social-channel coverage for channel-aware checks is:
...
Additional optional channels should be added when the source uses them materially:
...
- source has publishing_channels including any baseline channel
...
- generic web search returns insufficient results for a known social-first or channel-first source
```
...
- Newsletter RSS / public archive page when available
- Website / Linktree / bio link public page
```
...
4. Baseline channels should be audited: Instagram / X / Facebook / Threads / YouTube / TikTok / LINE OA / Newsletter / Website-Linktree.
5. If a social post says a law passed third reading, verify with 立法院 / 議案系統 / 金管會 / 中央社 / 全國法規資料庫.
```
...
```text
- Brand IG / X / FB / Threads / YouTube / TikTok / LINE OA / Newsletter / Website-Linktree may be first-source signals for launches, collaborations, pop-ups, discounts, closures, and new stores.
- Mall / department store Facebook, Instagram, Threads, LINE OA, Website / Event pages should be checked when tenant mix, event, pop-up, or footfall signals are required.
...
```text
- Instagram, Facebook, Threads, TikTok, LINE OA, and some newsletters may be inaccessible without login, permissions, or user-provided links/screenshots.
- X API access level affects search depth and cost.
- Third-party tools may have cost, rate, ToS, privacy, and reliability issues.
- OCR may be needed for image-only posts, videos, reels, shorts, or carousel screenshots.
```
