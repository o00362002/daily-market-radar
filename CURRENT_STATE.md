...
尚未完成：多 adapter 收集 stage 併入 run-daily（health 記錄／registry 選路）、real API-key 線上驗證、web projection、Astro static dashboard、daily scheduler、durable state branch、GitHub Pages、secrets contract（.env.example/redaction）。
