...
- [ ] 執行科技發展與突破雷達：AI for Science、生物、物理、化學、材料、能源、機器人、半導體、醫療、製造
...
- [ ] 搜尋 AI 實際應用三桶：企業導入 / Agent / 工作流替代 / 科技突破
...
- [ ] 資料不足必須明確寫出
- [ ] 跨領域事件標示所有受影響雷達
- [ ] 科技發展事件必須說明技術本質、影響領域、突破指標、商業化路徑、台灣映射
...
- [ ] 產出資料不足與不確定區
- [ ] 產出所有固定章節 0～21
- [ ] AI 段升級為「AI 與科技發展突破」，不可只寫 AI 公司新聞
